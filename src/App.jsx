  ...
  function HomePage() {
    ...
    return (
      <>
        ...
        {/* Hero Slider */}
        <section className="relative h-[40vh] md:h-[48vh] lg:h-[52vh] overflow-hidden mt-8 md:mt-16 lg:mt-24">
 ...
 <img
  ...
  alt="Oferta"
  className="w-full max-w-5xl h-[350px] md:h-[450px] lg:h-[500px] object-cover object-center mx-auto rounded-xl"
/>
