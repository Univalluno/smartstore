...
import mysql from 'mysql2/promise'; // Usando MySQL en lugar de Mongoose/MongoDB

import authRoutes from './routes/auth.js';
import passwordResetRoutes from './routes/passwordReset.js'; // Nueva ruta de Santiago
...
// ============================
// La conexión se crea como un pool, que es la forma recomendada
...
app.use('/api/password', passwordResetRoutes); // Agregando la nueva ruta de Santiago

// ============================
// Rutas para órdenes y facturas (Checkout y Pago)
// ============================
...
// ============================
// Servir archivos estáticos y rutas de React
// (Esto asume que React se construyó en la carpeta 'dist')
// ============================
